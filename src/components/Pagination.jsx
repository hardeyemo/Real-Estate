...
const posts = [
  ...
  { id: 8, picture: img3, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  ...
  { id: 12, picture: img1, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 13, picture: img2, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  ...
  { id: 17, picture: img2, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 18, picture: img3, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 19, picture: img1, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 20, picture: img2, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 21, picture: img3, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 22, picture: img2, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 23, picture: img1, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 24, picture: img3, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 25, picture: img2, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 26, picture: img1, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 27, picture: img3, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 28, picture: img3, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 29, picture: img3, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  ...
  { id: 33, picture: img3, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 34, picture: img3, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 35, picture: img3, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
  { id: 36, picture: img3, head: "Coastal Comfort", location: "Lekki, Lagos", amount: "NGN 500k/Y" },
...
const PaginatedPostList = ({ posts, postsPerPage }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-evenly mb-[80px]">
      <div className="  p-2 grid grid-cols-3  gap-10">
        {currentPosts.map(post => (
          <div key={post.id} className="p-4 flex flex-col items-center rounded">
            <img src={post.picture} alt={post.head} className="w-[20vw]" />
            <h2 className="text-lg font-bold">{post.head}</h2>
      ...
      <div className=" flex justify-center mt-5">
        <ReactPaginate
          ...
          previousLinkClassName="px-3 py-2 bg-black text-white rounded hover:bg-blue"
          nextLinkClassName="px-3 py-2 bg-black text-white rounded hover:bg-"
